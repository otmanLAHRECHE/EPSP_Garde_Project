...
class LaboratoireMainUi(QtWidgets.QMainWindow):
    ...
    def add_toDb(self):
        med_count = get_workers_count("labo")[0]
    ...
    def add_grd(self):
        ...
        guards_months_count = get_guard_months_count("labo")[0]
        ...
        if dialog.exec() == QtWidgets.QDialog.Accepted:
            if dialog.year.text() == "":
                ...
                self.thr = ThreadVerifyMonth(m, int(dialog.year.text()), "labo")
    ...
    def edit_g(self):
        ...
        self.urgence_guard_page = labo_guard.LaboGuardUi(m, y)
    ...
    def print_g(self):
        ...
        self.next_page = recap.RecapUi(m, y, "labo")
        self.close()
        self.next_page.show()
