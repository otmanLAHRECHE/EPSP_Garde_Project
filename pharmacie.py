...
class PharmacieMainUi(QtWidgets.QMainWindow):
    def __init__(self):
        super(PharmacieMainUi, self).__init__()
        uic.loadUi(os.path.join(basedir, 'ui', 'pharm.ui'), self)
    ...
    def add_toDb(self):
        med_count = get_workers_count("pharm")[0]
        if self.medcinname.text() == "":
            ...
            med = (self.medcinname.text(), 'pharm')
    ...
    def add_grd(self):
        ...
        guards_months_count = get_guard_months_count("pharm")[0]
    ...
    def edit_g(self):
        ...
        self.urgence_guard_page = pharm_guard.PharmGuardUi(m, y)
